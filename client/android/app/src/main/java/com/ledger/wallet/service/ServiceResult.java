...
import com.ledger.tbase.TlcLedgerWalletExchangeResult;
...
public class ServiceResult implements Parcelable {
	...
	public ServiceResult(TlcLedgerWalletExchangeResult result) {
		this.result = result.getResult();
		this.extendedResult = result.getExtendedResult();
	}
