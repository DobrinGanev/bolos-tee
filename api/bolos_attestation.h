 ...
 *
 * The legacy attestation logic let the client application verify that it is communicating with an application
 ...
 * 
 */
int bls_attestation_device_get_data_signature(const uint8_t WIDE *in, size_t length,
